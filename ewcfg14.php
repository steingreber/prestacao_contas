...
define("EW_PROJECT_NAME", "prestacao_contas", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME, TRUE); // Config file name
define("EW_PROJECT_ID", "{4608F4F3-4555-4766-9AD8-B0379A4856EE}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'OZUN5zUevXJkWW42', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/prestacao_contas.css", TRUE); // Project stylesheet file name
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "189.90.130.30", "port" => 3306, "user" => "gnovecom_rc43", "pass" => "S843Sc-.yp", "db" => "gnovecom_rc43", "qs" => "`", "qe" => "`");
...
$EW_LANGUAGE_FILE[] = array("en", "", "pt-br.xml");
...
define("EW_UPLOAD_DEST_PATH", "prestacao_contas/arquivos/", TRUE); // Upload destination path (relative to app root)
