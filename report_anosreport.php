...
<?php include_once "report_navbar_anos.php" ?>
		...
		<div class="container">
			<div class="row">
				<div  class="col-md-12">
				<p align="center" class="aviso0"><b>Nesta página voce terá acesso a dados, informações, relatorios,documentos e outros<br> recursos para acompanhar os contratos de parceria entre a entidade e o setor público.</b></p>
				</div>
			</div>
		</div>
		<div class="container">
...
?>
	...
	<?php echo "Vigência: ".$report_anos->ano_vigencia_ini->ViewValue; ?>
