...
$rc25_a_repasses_view = NULL; // Initialize page object first

class crc25_a_repasses_view extends crc25_a_repasses {
	...
	// Page object name
	var $PageObjName = 'rc25_a_repasses_view';
	...
	function __construct() {
		...
		$KeyUrl = "";
		if (@$_GET["repasse_id"] <> "") {
			$this->RecKey["repasse_id"] = $_GET["repasse_id"];
			$KeyUrl .= "&amp;repasse_id=" . urlencode($this->RecKey["repasse_id"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["repasse_id"] <> "") {
				...
				$this->RecKey["repasse_id"] = $this->repasse_id->QueryStringValue;
			} elseif (@$_POST["repasse_id"] <> "") {
				$this->repasse_id->setFormValue($_POST["repasse_id"]);
				$this->RecKey["repasse_id"] = $this->repasse_id->FormValue;
			} else {
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					...
					if (!$bMatchRecord) {
						if ($this->getSuccessMessage() == "" && $this->getFailureMessage() == "")
							$this->setFailureMessage($Language->Phrase("NoRecord")); // Set no record message
						$sReturnUrl = "rc25_a_repasseslist.php"; // No matching record, return to list
					} else {
						$this->LoadRowValues($this->Recordset); // Load row values
					}
			}
		} else {
			$sReturnUrl = "rc25_a_repasseslist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($rc25_a_repasses_view)) $rc25_a_repasses_view = new crc25_a_repasses_view();

// Page init
$rc25_a_repasses_view->Page_Init();

// Page main
$rc25_a_repasses_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$rc25_a_repasses_view->Page_Render();
?>
...
var CurrentForm = frc25_a_repassesview = new ew_Form("frc25_a_repassesview", "view");

// Form_CustomValidate event
frc25_a_repassesview.Form_CustomValidate = 
...
frc25_a_repassesview.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
frc25_a_repassesview.Lists["x_repasse_id_termos"] = {"LinkField":"x_processo_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_processo_termo_num","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"rc25_a_termos"};
frc25_a_repassesview.Lists["x_repasse_id_termos"].Data = "<?php echo $rc25_a_repasses_view->repasse_id_termos->LookupFilterQuery(FALSE, "view") ?>";
...
<div class="ewToolbar">
<?php $rc25_a_repasses_view->ExportOptions->Render("body") ?>
<?php
	foreach ($rc25_a_repasses_view->OtherOptions as &$option)
		$option->Render("body");
?>
<div class="clearfix"></div>
</div>
<?php $rc25_a_repasses_view->ShowPageHeader(); ?>
<?php
$rc25_a_repasses_view->ShowMessage();
?>
<?php if (!$rc25_a_repasses_view->IsModal) { ?>
<form name="ewPagerForm" class="form-inline ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($rc25_a_repasses_view->Pager)) $rc25_a_repasses_view->Pager = new cPrevNextPager($rc25_a_repasses_view->StartRec, $rc25_a_repasses_view->DisplayRecs, $rc25_a_repasses_view->TotalRecs, $rc25_a_repasses_view->AutoHidePager) ?>
<?php if ($rc25_a_repasses_view->Pager->RecordCount > 0 && $rc25_a_repasses_view->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($rc25_a_repasses_view->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $rc25_a_repasses_view->PageUrl() ?>start=<?php echo $rc25_a_repasses_view->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($rc25_a_repasses_view->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $rc25_a_repasses_view->PageUrl() ?>start=<?php echo $rc25_a_repasses_view->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $rc25_a_repasses_view->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($rc25_a_repasses_view->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $rc25_a_repasses_view->PageUrl() ?>start=<?php echo $rc25_a_repasses_view->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($rc25_a_repasses_view->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $rc25_a_repasses_view->PageUrl() ?>start=<?php echo $rc25_a_repasses_view->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $rc25_a_repasses_view->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
<?php } ?>
<form name="frc25_a_repassesview" id="frc25_a_repassesview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($rc25_a_repasses_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $rc25_a_repasses_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="rc25_a_repasses">
<input type="hidden" name="modal" value="<?php echo intval($rc25_a_repasses_view->IsModal) ?>">
<table class="table table-striped table-bordered table-hover table-condensed ewViewTable">
<?php if ($rc25_a_repasses->repasse_id_termos->Visible) { // repasse_id_termos ?>
	<tr id="r_repasse_id_termos">
		<td class="col-sm-2"><span id="elh_rc25_a_repasses_repasse_id_termos"><?php echo $rc25_a_repasses->repasse_id_termos->FldCaption() ?></span></td>
...
<?php echo $rc25_a_repasses->repasse_id_termos->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($rc25_a_repasses->repasse_faixa_etaria->Visible) { // repasse_faixa_etaria ?>
	<tr id="r_repasse_faixa_etaria">
		<td class="col-sm-2"><span id="elh_rc25_a_repasses_repasse_faixa_etaria"><?php echo $rc25_a_repasses->repasse_faixa_etaria->FldCaption() ?></span></td>
...
<?php echo $rc25_a_repasses->repasse_faixa_etaria->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($rc25_a_repasses->repasse_meta->Visible) { // repasse_meta ?>
	<tr id="r_repasse_meta">
		<td class="col-sm-2"><span id="elh_rc25_a_repasses_repasse_meta"><?php echo $rc25_a_repasses->repasse_meta->FldCaption() ?></span></td>
...
<?php echo $rc25_a_repasses->repasse_meta->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($rc25_a_repasses->repasse_valor_unitario->Visible) { // repasse_valor_unitario ?>
	<tr id="r_repasse_valor_unitario">
		<td class="col-sm-2"><span id="elh_rc25_a_repasses_repasse_valor_unitario"><?php echo $rc25_a_repasses->repasse_valor_unitario->FldCaption() ?></span></td>
...
<?php echo $rc25_a_repasses->repasse_valor_unitario->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($rc25_a_repasses->repasse_valor_mes->Visible) { // repasse_valor_mes ?>
	<tr id="r_repasse_valor_mes">
		<td class="col-sm-2"><span id="elh_rc25_a_repasses_repasse_valor_mes"><?php echo $rc25_a_repasses->repasse_valor_mes->FldCaption() ?></span></td>
...
<?php echo $rc25_a_repasses->repasse_valor_mes->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($rc25_a_repasses->repasse_valor_previsto->Visible) { // repasse_valor_previsto ?>
	<tr id="r_repasse_valor_previsto">
		<td class="col-sm-2"><span id="elh_rc25_a_repasses_repasse_valor_previsto"><?php echo $rc25_a_repasses->repasse_valor_previsto->FldCaption() ?></span></td>
...
<script type="text/javascript">
frc25_a_repassesview.Init();
</script>
<?php
$rc25_a_repasses_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$rc25_a_repasses_view->Page_Terminate();
?>
