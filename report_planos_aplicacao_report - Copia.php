...
class creport_planos_aplicacao_ extends cTableBase {
	...
	function getSqlGroupSelect() { // Select
		return ($this->_SqlGroupSelect <> "") ? $this->_SqlGroupSelect : "SELECT DISTINCT `plano_exercicio` FROM `rc25_a_planos_aplicacao`";
	}
...
<link rel="stylesheet" type="text/css" href="phpcss/meucss.css">
...
<?php echo $report_planos_aplicacao_->plano_exercicio->ViewValue ?></span>
</td></tr>
<?php
...
?>
	<tr>
		...
		<td class="ewGroupHeader"><?php echo $report_planos_aplicacao_->plano_despesa->FldCaption() ?></td>
		<td class="ewGroupHeader"><?php echo $report_planos_aplicacao_->plano_custo_mensal->FldCaption() ?></td>
		<td class="ewGroupHeader"><?php echo $report_planos_aplicacao_->plano_custo_exercicio->FldCaption() ?></td>
		<td class="ewGroupHeader"><?php echo $report_planos_aplicacao_->plano_recurso_municipal->FldCaption() ?></td>
		<td class="ewGroupHeader"><?php echo $report_planos_aplicacao_->plano_outros_recursos->FldCaption() ?></td>
	</tr>
<?php
	}
...
?>
	<tr>
		<td><div class="ewGroupIndent"></div></td>
		<td<?php echo $report_planos_aplicacao_->plano_despesa->CellAttributes() ?>>
...
<?php echo $report_planos_aplicacao_->plano_despesa->ViewValue ?></span>
		...
		<td<?php echo $report_planos_aplicacao_->plano_custo_mensal->CellAttributes() ?>>
...
<?php echo $report_planos_aplicacao_->plano_custo_mensal->ViewValue ?></span>
		...
		<td<?php echo $report_planos_aplicacao_->plano_custo_exercicio->CellAttributes() ?>>
...
<?php echo $report_planos_aplicacao_->plano_custo_exercicio->ViewValue ?></span>
		...
		<td<?php echo $report_planos_aplicacao_->plano_recurso_municipal->CellAttributes() ?>>
...
<?php echo $report_planos_aplicacao_->plano_recurso_municipal->ViewValue ?></span>
		...
		<td<?php echo $report_planos_aplicacao_->plano_outros_recursos->CellAttributes() ?>>
