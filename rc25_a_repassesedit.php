...
$rc25_a_repasses_edit = NULL; // Initialize page object first

class crc25_a_repasses_edit extends crc25_a_repasses {
	...
	// Page object name
	var $PageObjName = 'rc25_a_repasses_edit';
	...
	function Page_Main() {
		...
		if (@$_POST["a_edit"] <> "") {
			...
			// Load key from Form
			if ($objForm->HasValue("x_repasse_id")) {
		...
		if ($this->TotalRecs <= 0) { // No record found
			...
			$this->Page_Terminate("rc25_a_repasseslist.php"); // Return to list page
			...
			if (!is_null($this->repasse_id->CurrentValue)) {
				while (!$this->Recordset->EOF) {
					if (strval($this->repasse_id->CurrentValue) == strval($this->Recordset->fields('repasse_id'))) {
	...
	function LoadFormValues() {
		...
		if (!$this->repasse_id->FldIsDetailKey)
			$this->repasse_id->setFormValue($objForm->GetValue("x_repasse_id"));
	}
...
// Create page object
if (!isset($rc25_a_repasses_edit)) $rc25_a_repasses_edit = new crc25_a_repasses_edit();

// Page init
$rc25_a_repasses_edit->Page_Init();

// Page main
$rc25_a_repasses_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$rc25_a_repasses_edit->Page_Render();
?>
...
var CurrentForm = frc25_a_repassesedit = new ew_Form("frc25_a_repassesedit", "edit");

// Validate form
frc25_a_repassesedit.Validate = function() {
...
frc25_a_repassesedit.Form_CustomValidate = 
...
frc25_a_repassesedit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
frc25_a_repassesedit.Lists["x_repasse_id_termos"] = {"LinkField":"x_processo_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_processo_termo_num","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"rc25_a_termos"};
frc25_a_repassesedit.Lists["x_repasse_id_termos"].Data = "<?php echo $rc25_a_repasses_edit->repasse_id_termos->LookupFilterQuery(FALSE, "edit") ?>";
...
<?php $rc25_a_repasses_edit->ShowPageHeader(); ?>
<?php
$rc25_a_repasses_edit->ShowMessage();
?>
<?php if (!$rc25_a_repasses_edit->IsModal) { ?>
<form name="ewPagerForm" class="form-horizontal ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($rc25_a_repasses_edit->Pager)) $rc25_a_repasses_edit->Pager = new cPrevNextPager($rc25_a_repasses_edit->StartRec, $rc25_a_repasses_edit->DisplayRecs, $rc25_a_repasses_edit->TotalRecs, $rc25_a_repasses_edit->AutoHidePager) ?>
<?php if ($rc25_a_repasses_edit->Pager->RecordCount > 0 && $rc25_a_repasses_edit->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($rc25_a_repasses_edit->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $rc25_a_repasses_edit->PageUrl() ?>start=<?php echo $rc25_a_repasses_edit->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($rc25_a_repasses_edit->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $rc25_a_repasses_edit->PageUrl() ?>start=<?php echo $rc25_a_repasses_edit->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $rc25_a_repasses_edit->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($rc25_a_repasses_edit->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $rc25_a_repasses_edit->PageUrl() ?>start=<?php echo $rc25_a_repasses_edit->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($rc25_a_repasses_edit->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $rc25_a_repasses_edit->PageUrl() ?>start=<?php echo $rc25_a_repasses_edit->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $rc25_a_repasses_edit->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
<?php } ?>
<form name="frc25_a_repassesedit" id="frc25_a_repassesedit" class="<?php echo $rc25_a_repasses_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($rc25_a_repasses_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $rc25_a_repasses_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="rc25_a_repasses">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($rc25_a_repasses_edit->IsModal) ?>">
...
<?php if ($rc25_a_repasses->repasse_id_termos->Visible) { // repasse_id_termos ?>
	<div id="r_repasse_id_termos" class="form-group">
		<label id="elh_rc25_a_repasses_repasse_id_termos" for="x_repasse_id_termos" class="<?php echo $rc25_a_repasses_edit->LeftColumnClass ?>"><?php echo $rc25_a_repasses->repasse_id_termos->FldCaption() ?></label>
		<div class="<?php echo $rc25_a_repasses_edit->RightColumnClass ?>"><div<?php echo $rc25_a_repasses->repasse_id_termos->CellAttributes() ?>>
...
<?php if ($rc25_a_repasses->repasse_faixa_etaria->Visible) { // repasse_faixa_etaria ?>
	<div id="r_repasse_faixa_etaria" class="form-group">
		<label id="elh_rc25_a_repasses_repasse_faixa_etaria" for="x_repasse_faixa_etaria" class="<?php echo $rc25_a_repasses_edit->LeftColumnClass ?>"><?php echo $rc25_a_repasses->repasse_faixa_etaria->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $rc25_a_repasses_edit->RightColumnClass ?>"><div<?php echo $rc25_a_repasses->repasse_faixa_etaria->CellAttributes() ?>>
...
<?php if ($rc25_a_repasses->repasse_meta->Visible) { // repasse_meta ?>
	<div id="r_repasse_meta" class="form-group">
		<label id="elh_rc25_a_repasses_repasse_meta" for="x_repasse_meta" class="<?php echo $rc25_a_repasses_edit->LeftColumnClass ?>"><?php echo $rc25_a_repasses->repasse_meta->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $rc25_a_repasses_edit->RightColumnClass ?>"><div<?php echo $rc25_a_repasses->repasse_meta->CellAttributes() ?>>
...
<?php if ($rc25_a_repasses->repasse_valor_unitario->Visible) { // repasse_valor_unitario ?>
	<div id="r_repasse_valor_unitario" class="form-group">
		<label id="elh_rc25_a_repasses_repasse_valor_unitario" for="x_repasse_valor_unitario" class="<?php echo $rc25_a_repasses_edit->LeftColumnClass ?>"><?php echo $rc25_a_repasses->repasse_valor_unitario->FldCaption() ?></label>
		<div class="<?php echo $rc25_a_repasses_edit->RightColumnClass ?>"><div<?php echo $rc25_a_repasses->repasse_valor_unitario->CellAttributes() ?>>
...
<?php if ($rc25_a_repasses->repasse_valor_mes->Visible) { // repasse_valor_mes ?>
	<div id="r_repasse_valor_mes" class="form-group">
		<label id="elh_rc25_a_repasses_repasse_valor_mes" for="x_repasse_valor_mes" class="<?php echo $rc25_a_repasses_edit->LeftColumnClass ?>"><?php echo $rc25_a_repasses->repasse_valor_mes->FldCaption() ?></label>
		<div class="<?php echo $rc25_a_repasses_edit->RightColumnClass ?>"><div<?php echo $rc25_a_repasses->repasse_valor_mes->CellAttributes() ?>>
...
<?php if ($rc25_a_repasses->repasse_valor_previsto->Visible) { // repasse_valor_previsto ?>
	<div id="r_repasse_valor_previsto" class="form-group">
		<label id="elh_rc25_a_repasses_repasse_valor_previsto" for="x_repasse_valor_previsto" class="<?php echo $rc25_a_repasses_edit->LeftColumnClass ?>"><?php echo $rc25_a_repasses->repasse_valor_previsto->FldCaption() ?></label>
		<div class="<?php echo $rc25_a_repasses_edit->RightColumnClass ?>"><div<?php echo $rc25_a_repasses->repasse_valor_previsto->CellAttributes() ?>>
...
<input type="hidden" data-table="rc25_a_repasses" data-field="x_repasse_id" name="x_repasse_id" id="x_repasse_id" value="<?php echo ew_HtmlEncode($rc25_a_repasses->repasse_id->CurrentValue) ?>">
<?php if (!$rc25_a_repasses_edit->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $rc25_a_repasses_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $rc25_a_repasses_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
...
<script type="text/javascript">
frc25_a_repassesedit.Init();
</script>
<?php
$rc25_a_repasses_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$rc25_a_repasses_edit->Page_Terminate();
?>
