...
//
// Table class for report_rh_
//
class creport_rh_ extends cTableBase {
	var $rh_id;
	var $rh_exercicio;
	var $rh_terceirizado;
	var $rh_nome;
	...
	function __construct() {
		...
		$this->TableVar = 'report_rh_';
		$this->TableName = 'report_rh_';
		...
		// rh_id
		$this->rh_id = new cField('report_rh_', 'report_rh_', 'x_rh_id', 'rh_id', '`rh_id`', '`rh_id`', 20, -1, FALSE, '`rh_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// rh_exercicio
		$this->rh_exercicio = new cField('report_rh_', 'report_rh_', 'x_rh_exercicio', 'rh_exercicio', '`rh_exercicio`', '`rh_exercicio`', 3, -1, FALSE, '`rh_exercicio`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// rh_terceirizado
		$this->rh_terceirizado = new cField('report_rh_', 'report_rh_', 'x_rh_terceirizado', 'rh_terceirizado', '`rh_terceirizado`', '`rh_terceirizado`', 16, -1, FALSE, '`rh_terceirizado`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		...
		// rh_nome
		$this->rh_nome = new cField('report_rh_', 'report_rh_', 'x_rh_nome', 'rh_nome', '`rh_nome`', '`rh_nome`', 3, -1, FALSE, '`rh_nome`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// rh_escolaridade
		$this->rh_escolaridade = new cField('report_rh_', 'report_rh_', 'x_rh_escolaridade', 'rh_escolaridade', '`rh_escolaridade`', '`rh_escolaridade`', 200, -1, FALSE, '`rh_escolaridade`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->rh_escolaridade->Sortable = FALSE; // Allow sort
		$this->fields['rh_escolaridade'] = &$this->rh_escolaridade;

		// rh_funcao
		$this->rh_funcao = new cField('report_rh_', 'report_rh_', 'x_rh_funcao', 'rh_funcao', '`rh_funcao`', '`rh_funcao`', 3, -1, FALSE, '`rh_funcao`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// rh_sala_turma
		$this->rh_sala_turma = new cField('report_rh_', 'report_rh_', 'x_rh_sala_turma', 'rh_sala_turma', '`rh_sala_turma`', '`rh_sala_turma`', 200, -1, FALSE, '`rh_sala_turma`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->rh_sala_turma->Sortable = FALSE; // Allow sort
		$this->fields['rh_sala_turma'] = &$this->rh_sala_turma;

		// rh_carga_horaria_semanal
		$this->rh_carga_horaria_semanal = new cField('report_rh_', 'report_rh_', 'x_rh_carga_horaria_semanal', 'rh_carga_horaria_semanal', '`rh_carga_horaria_semanal`', '`rh_carga_horaria_semanal`', 200, -1, FALSE, '`rh_carga_horaria_semanal`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// rh_remuneracao
		$this->rh_remuneracao = new cField('report_rh_', 'report_rh_', 'x_rh_remuneracao', 'rh_remuneracao', '`rh_remuneracao`', '`rh_remuneracao`', 5, -1, FALSE, '`rh_remuneracao`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->rh_pg_recurso_publico = new cField('report_rh_', 'report_rh_', 'x_rh_pg_recurso_publico', 'rh_pg_recurso_publico', '`rh_pg_recurso_publico`', '`rh_pg_recurso_publico`', 16, -1, FALSE, '`rh_pg_recurso_publico`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		...
		// rh_hora_entra_i
		$this->rh_hora_entra_i = new cField('report_rh_', 'report_rh_', 'x_rh_hora_entra_i', 'rh_hora_entra_i', '`rh_hora_entra_i`', '`rh_hora_entra_i`', 200, -1, FALSE, '`rh_hora_entra_i`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->rh_hora_entra_i->Sortable = FALSE; // Allow sort
		$this->fields['rh_hora_entra_i'] = &$this->rh_hora_entra_i;

		// rh_hora_saida_i
		$this->rh_hora_saida_i = new cField('report_rh_', 'report_rh_', 'x_rh_hora_saida_i', 'rh_hora_saida_i', '`rh_hora_saida_i`', '`rh_hora_saida_i`', 200, -1, FALSE, '`rh_hora_saida_i`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->rh_hora_saida_i->Sortable = FALSE; // Allow sort
		$this->fields['rh_hora_saida_i'] = &$this->rh_hora_saida_i;

		// rh_hora_entra_ii
		$this->rh_hora_entra_ii = new cField('report_rh_', 'report_rh_', 'x_rh_hora_entra_ii', 'rh_hora_entra_ii', '`rh_hora_entra_ii`', '`rh_hora_entra_ii`', 200, -1, FALSE, '`rh_hora_entra_ii`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->rh_hora_entra_ii->Sortable = FALSE; // Allow sort
		$this->fields['rh_hora_entra_ii'] = &$this->rh_hora_entra_ii;

		// rh_hora_saida_ii
		$this->rh_hora_saida_ii = new cField('report_rh_', 'report_rh_', 'x_rh_hora_saida_ii', 'rh_hora_saida_ii', '`rh_hora_saida_ii`', '`rh_hora_saida_ii`', 3, -1, FALSE, '`rh_hora_saida_ii`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// rh_data_cadastro
		$this->rh_data_cadastro = new cField('report_rh_', 'report_rh_', 'x_rh_data_cadastro', 'rh_data_cadastro', '`rh_data_cadastro`', ew_CastDateFieldForLike('`rh_data_cadastro`', 7, "DB"), 135, 7, FALSE, '`rh_data_cadastro`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlDetailSelect() { // Select
		$recebe_ano =  intval($_GET['ano']);
		return ($this->_SqlDetailSelect <> "") ? $this->_SqlDetailSelect : "SELECT * FROM `rc25_a_recursos_humanos` Where rh_exercicio = $recebe_ano and rh_terceirizado = 0";
	}
...
$report_rh__report = NULL; // Initialize page object first

class creport_rh__report extends creport_rh_ {
	...
	// Table name
	var $TableName = 'report_rh_';

	// Page object name
	var $PageObjName = 'report_rh__report';
	...
	function __construct() {
		...
		// Table object (report_rh_)
		if (!isset($GLOBALS["report_rh_"]) || get_class($GLOBALS["report_rh_"]) == "creport_rh_") {
			$GLOBALS["report_rh_"] = &$this;
			$GLOBALS["Table"] = &$GLOBALS["report_rh_"];
		}
		...
		if (!defined("EW_TABLE_NAME"))
			define("EW_TABLE_NAME", 'report_rh_', TRUE);
	...
	function Page_Main() {
		...
		$this->ReportTotals = &ew_Init2DArray(1, 12, 0);
		$this->ReportMaxs = &ew_Init2DArray(1, 12, 0);
		$this->ReportMins = &ew_Init2DArray(1, 12, 0);
...
// Create page object
if (!isset($report_rh__report)) $report_rh__report = new creport_rh__report();

// Page init
$report_rh__report->Page_Init();

// Page main
$report_rh__report->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$report_rh__report->Page_Render();
?>
<?php include_once "header.php" ?>
<?php if ($report_rh_->Export == "") { ?>
...
<?php } ?>
<?php
$report_rh__report->RecCnt = 1; // No grouping
if ($report_rh__report->DbDetailFilter <> "") {
	if ($report_rh__report->ReportFilter <> "") $report_rh__report->ReportFilter .= " AND ";
	$report_rh__report->ReportFilter .= "(" . $report_rh__report->DbDetailFilter . ")";
}
$ReportConn = &$report_rh__report->Connection();

// Set up detail SQL
$report_rh_->CurrentFilter = $report_rh__report->ReportFilter;
$report_rh__report->ReportSql = $report_rh_->DetailSQL();

// Load recordset
$report_rh__report->Recordset = $ReportConn->Execute($report_rh__report->ReportSql);
$report_rh__report->RecordExists = !$report_rh__report->Recordset->EOF;
?>
<?php if ($report_rh_->Export == "") { ?>
<?php if ($report_rh__report->RecordExists) { ?>
<div class="ewViewExportOptions"><?php $report_rh__report->ExportOptions->Render("body") ?></div>
<?php } ?>
<?php } ?>
<?php $report_rh__report->ShowPageHeader(); ?>
<!--<table class="ewReportTable">-->
<?php

	// Get detail records
	$report_rh__report->ReportFilter = $report_rh__report->DefaultFilter;
	if ($report_rh__report->DbDetailFilter <> "") {
		if ($report_rh__report->ReportFilter <> "")
			$report_rh__report->ReportFilter .= " AND ";
		$report_rh__report->ReportFilter .= "(" . $report_rh__report->DbDetailFilter . ")";
	}
	...
	// Load detail records
	$report_rh__report->DetailRecordset = $ReportConn->Execute($report_rh__report->ReportSql);
	$report_rh__report->DtlRecordCount = $report_rh__report->DetailRecordset->RecordCount();

	// Initialize aggregates
	if (!$report_rh__report->DetailRecordset->EOF) {
		$report_rh__report->RecCnt++;
	}
	if ($report_rh__report->RecCnt == 1) {
		$report_rh__report->ReportCounts[0] = 0;
	}
	$report_rh__report->ReportCounts[0] += $report_rh__report->DtlRecordCount;
	if ($report_rh__report->RecordExists) {
?>
...
<div class="container">
	<div class="row">
		<div class="col-md-12 text-center" style="background-color: #fff; box-shadow: 3px 3px 6px; border-radius:10px;">
			<br>
			<div class="quadros">
				<h1>Recursos Humanos Exercício <?php echo $recebe_ano ?></h1>
			</div>

			<table border="0" style="border-collapse: collapse; width: 100%;">

	<tr class="tr-campos">
		<td class="td-direita"><?php echo $report_rh_->rh_nome->FldCaption() ?></td>
		<td class="td-direita"><?php echo $report_rh_->rh_escolaridade->FldCaption() ?></td>
		<td class="td-direita"><?php echo $report_rh_->rh_funcao->FldCaption() ?></td>
		<td class="td-direita"><?php echo $report_rh_->rh_sala_turma->FldCaption() ?></td>
		<td class="td-direita"><?php echo $report_rh_->rh_carga_horaria_semanal->FldCaption() ?></td>
		<td class="td-direita"><?php echo $report_rh_->rh_remuneracao->FldCaption() ?></td>
		<td class="td-direita"><?php echo $report_rh_->rh_pg_recurso_publico->FldCaption() ?></td>
		<td class="td-direita"><?php echo $report_rh_->rh_hora_entra_i->FldCaption() ?></td>
		<td class="td-direita"><?php echo $report_rh_->rh_hora_saida_i->FldCaption() ?></td>
		<td class="td-direita"><?php echo $report_rh_->rh_hora_entra_ii->FldCaption() ?></td>
		<td class="td-direita"><?php echo $report_rh_->rh_hora_saida_ii->FldCaption() ?></td>
	</tr>
<?php
	}
	while (!$report_rh__report->DetailRecordset->EOF) {
		$report_rh__report->RowCnt++;
		$report_rh_->rh_nome->setDbValue($report_rh__report->DetailRecordset->fields('rh_nome'));
		$report_rh_->rh_escolaridade->setDbValue($report_rh__report->DetailRecordset->fields('rh_escolaridade'));
		$report_rh_->rh_funcao->setDbValue($report_rh__report->DetailRecordset->fields('rh_funcao'));
		$report_rh_->rh_sala_turma->setDbValue($report_rh__report->DetailRecordset->fields('rh_sala_turma'));
		$report_rh_->rh_carga_horaria_semanal->setDbValue($report_rh__report->DetailRecordset->fields('rh_carga_horaria_semanal'));
		$report_rh_->rh_remuneracao->setDbValue($report_rh__report->DetailRecordset->fields('rh_remuneracao'));
		$report_rh_->rh_pg_recurso_publico->setDbValue($report_rh__report->DetailRecordset->fields('rh_pg_recurso_publico'));
		$report_rh_->rh_hora_entra_i->setDbValue($report_rh__report->DetailRecordset->fields('rh_hora_entra_i'));
		$report_rh_->rh_hora_saida_i->setDbValue($report_rh__report->DetailRecordset->fields('rh_hora_saida_i'));
		$report_rh_->rh_hora_entra_ii->setDbValue($report_rh__report->DetailRecordset->fields('rh_hora_entra_ii'));
		$report_rh_->rh_hora_saida_ii->setDbValue($report_rh__report->DetailRecordset->fields('rh_hora_saida_ii'));

		// Render for view
		$report_rh_->RowType = EW_ROWTYPE_VIEW;
		$report_rh_->ResetAttrs();
		$report_rh__report->RenderRow();
?>
	<tr>
		<td class="td-direita">
<span<?php echo $report_rh_->rh_nome->ViewAttributes() ?>>
<?php echo $report_rh_->rh_nome->ViewValue ?></span>
</td>
		<td class="td-direita">
<span<?php echo $report_rh_->rh_escolaridade->ViewAttributes() ?>>
<?php echo $report_rh_->rh_escolaridade->ViewValue ?></span>
</td>
		<td class="td-direita">
<span<?php echo $report_rh_->rh_funcao->ViewAttributes() ?>>
<?php echo $report_rh_->rh_funcao->ViewValue ?></span>
</td>
		<td class="td-direita">
<span<?php echo $report_rh_->rh_sala_turma->ViewAttributes() ?>>
<?php echo $report_rh_->rh_sala_turma->ViewValue ?></span>
</td>
		<td class="td-direita">
<span<?php echo $report_rh_->rh_carga_horaria_semanal->ViewAttributes() ?>>
<?php echo $report_rh_->rh_carga_horaria_semanal->ViewValue ?></span>
</td>
		<td class="td-direita">
<span<?php echo $report_rh_->rh_remuneracao->ViewAttributes() ?>>
<?php echo $report_rh_->rh_remuneracao->ViewValue ?></span>
</td>
		<td class="td-direita">
<span<?php echo $report_rh_->rh_pg_recurso_publico->ViewAttributes() ?>>
<?php echo $report_rh_->rh_pg_recurso_publico->ViewValue ?></span>
</td>
		<td class="td-direita">
<span<?php echo $report_rh_->rh_hora_entra_i->ViewAttributes() ?>>
<?php echo $report_rh_->rh_hora_entra_i->ViewValue ?></span>
</td>
		<td class="td-direita">
<span<?php echo $report_rh_->rh_hora_saida_i->ViewAttributes() ?>>
<?php echo $report_rh_->rh_hora_saida_i->ViewValue ?></span>
</td>
		<td class="td-direita">
<span<?php echo $report_rh_->rh_hora_entra_ii->ViewAttributes() ?>>
<?php echo $report_rh_->rh_hora_entra_ii->ViewValue ?></span>
</td>
		<td class="td-direita">
<span<?php echo $report_rh_->rh_hora_saida_ii->ViewAttributes() ?>>
<?php echo $report_rh_->rh_hora_saida_ii->ViewValue ?></span>
</td>
	</tr>
<?php
		$report_rh__report->DetailRecordset->MoveNext();
	}
	$report_rh__report->DetailRecordset->Close();
?>
<?php if ($report_rh__report->RecordExists) { ?>
	<tr><td colspan=11>&nbsp;<br></td></tr>
	<tr><td colspan=11 class="ewGrandSummary"><?php echo $Language->Phrase("RptGrandTotal") ?>&nbsp;(<?php echo ew_FormatNumber($report_rh__report->ReportCounts[0], 0) ?>&nbsp;<?php echo $Language->Phrase("RptDtlRec") ?>)</td></tr>
<?php } ?>
<?php if ($report_rh__report->RecordExists) { ?>
	<tr class="tr-campos"><td colspan=11>&nbsp;<br></td></tr>
<?php } else { ?>
...
<?php
$report_rh__report->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($report_rh_->Export == "") { ?>
...
<?php
$report_rh__report->Page_Terminate();
?>
