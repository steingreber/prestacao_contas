...
if (!function_exists('DbHelper')) {
	...
	function &DbHelper($dbid = "", $langfolder = "", $langid = "", $info = NULL) {
		...
		$dbclass = "cgnovecom_rc43_db";
		$dbhelper = new $dbclass($langfolder, $langid, $info);
		return $dbhelper;
	}
}

class cgnovecom_rc43_db extends cDbHelper {

	// Database connection info
	var $Host = '189.90.130.30';
	var $Port = 3306;
	var $Username = 'gnovecom_rc43';
	var $Password = 'S843Sc-.yp';
	var $DbName = 'gnovecom_rc43';
	var $CharSet = "utf-8";
