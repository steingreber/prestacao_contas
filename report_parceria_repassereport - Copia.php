...
class creport_parceria_repasse extends cTableBase {
	...
	function getSqlGroupSelect() { // Select
		return ($this->_SqlGroupSelect <> "") ? $this->_SqlGroupSelect : "SELECT DISTINCT `pExercicio` FROM `view_parceira_repase`";
	}
...
?>
	<!--<tr><td class="ewGroupField"><?php echo $report_parceria_repasse->pExercicio->FldCaption() ?></td>
	<td colspan=33 class="ewGroupName">
<span<?php echo $report_parceria_repasse->pExercicio->ViewAttributes() ?>>-->
<h1>Exercício <?php echo $report_parceria_repasse->pExercicio->ViewValue ?></h1>
<!--</td></tr>-->
<?php
	}
...
<b>Valor: </b>R$<?php echo $report_parceria_repasse->pValor->ViewValue ?><br>
...
<b>Origem: </b><?php echo $report_parceria_repasse->pOrigem->ViewValue ?><hr>
<h4>Dados da Entidade</h4>
<b>Endereço: </b><?php echo $report_parceria_repasse->pEntidadeEdereco->ViewValue ?><br>
<b>Estatuto </b><?php echo ew_GetFileViewTag($report_parceria_repasse->pEntidadeEstatuto, $report_parceria_repasse->pEntidadeEstatuto->ViewValue) ?>
<b>Lei Utilidade Publica Municipal: </b><?php echo $report_parceria_repasse->pEntidadeLei->ViewValue ?><br>
<b>Cebas: </b><?php echo $report_parceria_repasse->pEntidadeCebas->ViewValue ?><hr>
<h4>Responsável</h4>
...
<b>Ata Nomeação: </b><?php echo $report_parceria_repasse->pRespAta->ViewValue ?><hr>
<h4>Contador(a)</h4>
...
<b>Identificação: </b><?php echo $report_parceria_repasse->pContDocumento->ViewValue ?><hr>
...
<b>Identificação: </b><?php echo $report_parceria_repasse->pPrencherDocumento->ViewValue ?><hr>
<h2>Valores dos repasses R$</h2>
	<?php
		$repasse = 2;
	...
	<tr>
		...
		<td>&nbsp;</td>
		<td>&nbsp;</td>	
	<td<?php echo $report_parceria_repasse->rIDRepasse->CellAttributes() ?>>
<span<?php echo $report_parceria_repasse->rIDRepasse->ViewAttributes() ?>>
<?php echo $report_parceria_repasse->rIDRepasse->ViewValue ?></span>
</td>
		<td<?php echo $report_parceria_repasse->rFaixaEtaria->CellAttributes() ?>>
<span<?php echo $report_parceria_repasse->rFaixaEtaria->ViewAttributes() ?>>
<?php echo $report_parceria_repasse->rFaixaEtaria->ViewValue ?></span>
</td>
		<td<?php echo $report_parceria_repasse->rMeta->CellAttributes() ?>>
<span<?php echo $report_parceria_repasse->rMeta->ViewAttributes() ?>>
<?php echo $report_parceria_repasse->rMeta->ViewValue ?></span>
</td>
		<td<?php echo $report_parceria_repasse->rValorUnitario->CellAttributes() ?>>
...
<?php echo $report_parceria_repasse->rValorUnitario->ViewValue ?></span>
		...
		<td<?php echo $report_parceria_repasse->rValorMensal->CellAttributes() ?>>
...
<?php echo $report_parceria_repasse->rValorMensal->ViewValue ?></span>
		...
		<td<?php echo $report_parceria_repasse->rValorPrevisto->CellAttributes() ?>>
...
?>
	<tr><td colspan=11 class="ewGroupSummary"><?php echo $Language->Phrase("RptSumHead") ?>&nbsp;<?php echo $report_parceria_repasse->pExercicio->FldCaption() ?>:&nbsp;<?php echo $report_parceria_repasse->pExercicio->ViewValue ?> (<?php echo ew_FormatNumber($report_parceria_repasse_report->ReportCounts[1],0) ?> <?php echo $Language->Phrase("RptDtlRec") ?>)</td></tr>
<?php
...
<?php if ($report_parceria_repasse_report->RecordExists) { ?>
	...
	<tr><td colspan=11 class="ewGrandSummary"><?php echo $Language->Phrase("RptGrandTotal") ?>&nbsp;(<?php echo ew_FormatNumber($report_parceria_repasse_report->ReportCounts[0], 0) ?>&nbsp;<?php echo $Language->Phrase("RptDtlRec") ?>)</td></tr>
-->
<?php
