...
$report_parceria_repasse_pEntidadeEstatuto_blobview = NULL; // Initialize page object first

class creport_parceria_repasse_pEntidadeEstatuto_blobview extends cview_parceira_repase {
	...
	// Page object name
	var $PageObjName = 'report_parceria_repasse_pEntidadeEstatuto_blobview';
	...
	function Page_Main() {
		...
		// Get key
		$fld = $this->fields["pEntidadeEstatuto"];
...
// Create page object
if (!isset($report_parceria_repasse_pEntidadeEstatuto_blobview)) $report_parceria_repasse_pEntidadeEstatuto_blobview = new creport_parceria_repasse_pEntidadeEstatuto_blobview();

// Page init
$report_parceria_repasse_pEntidadeEstatuto_blobview->Page_Init();

// Page main
$report_parceria_repasse_pEntidadeEstatuto_blobview->Page_Main();
?>
<?php
$report_parceria_repasse_pEntidadeEstatuto_blobview->Page_Terminate();
?>
