...
$view_parceira_repase_pEntidadeEstatuto_blobview = NULL; // Initialize page object first

class cview_parceira_repase_pEntidadeEstatuto_blobview extends cview_parceira_repase {
	...
	// Page object name
	var $PageObjName = 'view_parceira_repase_pEntidadeEstatuto_blobview';
...
// Create page object
if (!isset($view_parceira_repase_pEntidadeEstatuto_blobview)) $view_parceira_repase_pEntidadeEstatuto_blobview = new cview_parceira_repase_pEntidadeEstatuto_blobview();

// Page init
$view_parceira_repase_pEntidadeEstatuto_blobview->Page_Init();

// Page main
$view_parceira_repase_pEntidadeEstatuto_blobview->Page_Main();
?>
<?php
$view_parceira_repase_pEntidadeEstatuto_blobview->Page_Terminate();
?>
